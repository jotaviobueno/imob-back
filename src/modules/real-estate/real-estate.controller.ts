...
export class RealEstateController {
  ...
  @Post()
  @Permissions(PERMISSION_ENUM.CAN_CREATE_REAL_ESTATE)
  ...
  @Get()
  @Permissions(PERMISSION_ENUM.CAN_READ_REAL_ESTATE)
  ...
  @Patch(':id')
  @Permissions(PERMISSION_ENUM.CAN_UPDATE_REAL_ESTATE)
  @UseInterceptors(FilesInterceptor('files', 5))
  update(
    @Param('id') id: string,
  ...
  @Delete(':id')
  @Permissions(PERMISSION_ENUM.CAN_DELETE_REAL_ESTATE)
